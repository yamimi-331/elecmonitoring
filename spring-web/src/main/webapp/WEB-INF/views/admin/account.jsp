...
<body>
	...
	// 계정 복구 버튼
	function restoreAccount(accountId, userType) {
	...
	function updateStaff() {
		...
		const staffNm = $("#modal-staff-nm").val();
		const staffRole = $("#modal-staff-role").val();
		const staffAddr = $("#modal-staff-addr").val();
